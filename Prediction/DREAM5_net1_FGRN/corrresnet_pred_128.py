...
class Classifier(nn.Module):
    def __init__(self, args,output_directory, nb_classes, x_tarin1, x_tarin2, net_emd_tf_s, net_emd_tf_t, net_emd_target_s, net_emd_target_t, device='cuda', verbose=False, build=True, load_weights=False, patience=5):
    ...
    def fit_5CV(self, x_train_1, x_train_2, net_emd_tf_s_train, net_emd_tf_t_train, net_emd_target_s_train,net_emd_target_t_train, y_train,
        ...
        for epoch in range(nb_epochs):
            ...
            for inputs in train_loader:
                ...
                labels = labels.to(self.device)  # 确保标签也被转移到相同的设备
