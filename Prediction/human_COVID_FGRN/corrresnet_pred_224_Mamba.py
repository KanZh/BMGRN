...
# from effi_KAN import KAN
from KANConv import KANConv1DLayer as KANConv
from nd_mamba2_fix import NdMamba2_1d
import time
...
class Classifier(nn.Module):
    def __init__(self, args, output_directory, nb_classes, x_tarin1, x_tarin2, net_emd_tf_s, net_emd_tf_t,
        ...
        self.mamba = NdMamba2_1d(2, 128, 128)
    ...
    def forward(self, x_train1, x_train2, net_emd_tf_s, net_emd_tf_t, net_emd_target_s, net_emd_target_t):
        ...
        combined_features = torch.cat([f1, f2], dim=1)  # Combine along feature dimension
        ...
        # print(f'input_layer_net_tf_s_ shape: {input_layer_net_tf_s_.shape}')
        # print(f'input_layer_net_tf_t_ shape: {input_layer_net_tf_t_.shape}')
        # print(f'input_layer_net_target_s_ shape: {input_layer_net_target_s_.shape}')
        # print(f'input_layer_net_target_t_ shape: {input_layer_net_target_t_.shape}')
    ...
    def fit_5CV(self, x_train_1, x_train_2, net_emd_tf_s_train, net_emd_tf_t_train, net_emd_target_s_train,
        ...
        # class_weights = class_weight.compute_class_weight(class_weight='balanced', classes=np.unique(y_train_num),
        #                                                   y=y_train_num)
